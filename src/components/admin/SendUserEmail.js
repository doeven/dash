...
useEffect(()=>{
    const tmp = {...email};
    const username = props.location.state ? props.location.state.username : tmp.usernames;
...
const handleOnSubmit = e => {
    ...
    http.post('api/admin/email/single', email).then( response => {
